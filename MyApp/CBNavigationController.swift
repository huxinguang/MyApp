...
public enum CBNavigationBackGroundType
{
    case Normal
    case Translucent
    case Black
...
{
    // 设置navigation是否可以滑动
    public func setCanDragBack(isCanDrag : Bool)
    {
    ...
    // 设置backgroundtype
    public func setBackGroundType(backGroundType : CBNavigationBackGroundType)
    {
...
//        topBarImage = topBarImage.resizableImage(withCapInsets: UIEdgeInsets.init(top: 20, left: 50, bottom: 20, right: 50));
        ...
        self.setStatusBarStyle(statusBarStyle: UIStatusBarStyle.default);
...
//        imageView.layer.shadowPath
    ...
    func setGrayNavigationBar()
    {
        ...
        self.navigationBar.isTranslucent = true;
        self.navigationBar.barStyle = UIBarStyle.default;
        self.setStatusBarStyle(statusBarStyle: UIStatusBarStyle.lightContent);
    }
    
    func setWhileNavigationBar()
    {
        self.navigationBar.barTintColor = CBUtil.colorWithRGB(0xffffff);
        self.navigationBar.isTranslucent = true;
        self.navigationBar.barStyle = UIBarStyle.default;
...
//        }
    ...
    func prepareTranstionViews(forRootViewController : Bool)
    {
        ...
        {
            self.backgroundView.transform = CGAffineTransform.init(rotationAngle: -(CGFloat)(M_PI_2));
