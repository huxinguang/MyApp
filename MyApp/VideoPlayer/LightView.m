...
- (instancetype)init{
    ...
    if (self) {
        ...
        self.centerLightIV.image = [UIImage imageNamed:[@"VideoPlayer.bundle" stringByAppendingPathComponent:@"play_new_brightness_day"]];
...
- (void)layoutSubviews {
    ...
    self.transform = [VideoPlayer getCurrentDeviceOrientation];
